...
-- EMPLEADO (cambié RecursoHumano por Empleado que es como está en tu esquema)
...
-- PRODUCTO (ajustado para coincidir con tu esquema)
-- PRODUCTO (datos actualizados con artículos de decoración)
...
-- ORDEN_SERVICIO (añadí algunas órdenes de servicio como ejemplo)
